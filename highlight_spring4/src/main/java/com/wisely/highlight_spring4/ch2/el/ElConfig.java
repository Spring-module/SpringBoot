...
public class ElConfig {
	...
	@Value("I Love You!") //1 普通字符串
    private String normal;

	@Value("#{systemProperties['os.name']}") //2 操作系统属性
	private String osName;
	
	@Value("#{ T(java.lang.Math).random() * 100.0 }") //3 表达式结果
    private double randomNumber;

	@Value("#{demoService.another}") //4 其他Bean属性
	private String fromAnother;

	@Value("classpath:com/wisely/highlight_spring4/ch2/el/test.txt") //5 文件资源
	private Resource testFile;

	@Value("http://www.baidu.com") //6 网址资源
